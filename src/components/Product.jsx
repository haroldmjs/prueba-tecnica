...
const Product = ({ product }) => {
  ...
  return (
    <div className='rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 bg-white'>
      ...
      <div className='pt-6'>
        ...
        <a href='#' className='text-lg font-semibold leading-tight text-gray-900 hover:underline '>{product.title}</a>
        ...
        <div className='mt-2 flex items-center gap-2'>
          ...
          <p className='text-sm font-medium text-gray-900'>{product.rating.rate}</p>
        ...
        <div className='mt-4 flex items-center justify-between gap-4'>
          ...
          <button type='button' className='inline-flex items-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-gray-500 hover:bg-primary-800 focus:outline-none focus:ring-4  focus:ring-primary-300' onClick={() => openProduct(product.id)}>
            Ver producto
          </button>
        </div>
      </div>
